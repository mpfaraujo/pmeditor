...
/**
 * Mantém todos os grupos/ações existentes.
 * O grupo "Opções" (checkbox) foi removido: agora o controle de opções é +/- na UI
 * (DesktopSidebar / HorizontalToolbar) acionando "inc-options" e "dec-options".
 */
